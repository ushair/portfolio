const HeaderBg = () => {
  return (
    <div className="absolute top-0 bottom-0 left-0 right-0 bg-bannerColor -z-10 header-background">
      ...
      <div className="absolute top-24 right-24 bg-[#1D6750] w-5/12 h-[200px] rounded" />
      <div className="absolute bottom-24 left-12 bg-[#1371A7] w-[200px] h-[200px] rounded" />
      <div className="absolute right-12 bottom-24 bg-[#915DFF] w-[200px] h-[200px] rounded" />
    </div>
  );
};
